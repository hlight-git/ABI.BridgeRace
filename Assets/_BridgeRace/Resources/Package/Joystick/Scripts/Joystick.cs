    ...
    IPointerUpHandler
{
    ...
    public virtual void OnDrag(PointerEventData eventData)
    {
        ...
        controlTarget.MoveToward(direction, offset.magnitude);
    }
    ...
    public void SetTarget(MonoBehaviour joystickControlTarget)
    {
        controlTarget = joystickControlTarget.GetComponent<IJoystickControllable>();
    }
}
